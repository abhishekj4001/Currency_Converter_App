...
public class XCoinActivity extends Activity implements OnClickListener, OnItemSelectedListener, TextWatcher
{
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		setContentView(R.layout.activity_xcoin);
	            ...
	            try 
	            {
	                ...
	                new AsyncTask<Void, Void, Double>() 
	                {
	                    ...
	                    protected Double doInBackground(Void... params)
	                    {
	                        ...
	                        try 
	                        {
	                            double rate = XCoinActivity.this.currencyConverter.getConversionRate(fromCurrencyCode, toCurrencyCode);
	                    ...
	                    protected void onPostExecute(Double rate)
	                    {
	                        if (rate == null) 
	                        {
	                        	XCoinActivity.this.clearOutput();
	                            Toast.makeText(XCoinActivity.this, R.string.convert_failure, Toast.LENGTH_SHORT).show();
	                        } 
	                        else 
	                        {
	                        	XCoinActivity.this.setOutput(String.valueOf(rate.doubleValue() * amount));
	                        }
	                    }
	                }.execute();
	            } 
